<div align="center">
  ...
  **AI-Powered Noise Suppression for macOS**
  ...
  <a href="https://github.com/Ghostkwebb/MetalVoice/releases/latest/download/MetalVoice_v1.2.2.zip">
    <img src="https://img.shields.io/badge/Download-MetalVoice_v1.2.2-blue?style=for-the-badge&logo=apple&logoColor=white" alt="Download MetalVoice" />
  </a>
...
2.  **Unzip**: Extract `MetalVoice_v1.2.2.zip`. Inside, you'll find the GUI `MetalVoice.app` and the terminal `MetalVoiceCLI`.
